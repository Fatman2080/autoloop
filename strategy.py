...
改进说明：
- 基于 R86 配置（val_score=2.1159），将做多仓位从 25% 提升到 30%
- 参考 R75 的成功经验：L30%/S50% 达到 val_score=2.3323
- 保持 Keltner 通道 2.5x + EMA150 斜率熊市检测 + ADX>25 + 成交量确认 1.1x

预期：更高的做多仓位可以在牛市/震荡市中获得更多收益
"""
