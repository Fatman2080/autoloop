...
- EMA150斜率计算从96周期改为30周期，使熊市检测更稳定灵敏
- 保持做空70%仓位 + Keltner 2.5x + ADX>25 + 成交量1.1x确认
- 出场窗口保持36

预期：更合理的斜率周期 → 更准确的牛熊判断 → 提升val_score
"""
...
def generate_signals(candles: pd.DataFrame) -> pd.Series:
    ...
    # 关键改进：斜率周期从96改为30，使检测更稳定
    ema150_slope = ema150 / ema150.shift(30) - 1
