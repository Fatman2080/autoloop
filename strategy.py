"""
strategy.py — 量化交易策略
改进：R75仓位(L30%/S50%) + 做空出场从36→28周期，更快止盈
"""
...
def generate_signals(candles: pd.DataFrame) -> pd.Series:
    ...
    # ── 做多系统：Donchian(58/28) + Keltner上轨(2.0x) + 成交量 → 30% ──
    ...
    # ── 做空系统：Keltner下轨(2.0x) + 熊市 + ADX>25 → 50% ──
    # 改进：出场从36周期改为28周期，更快止盈
    exit_high = high.rolling(28).max()  # 从36改为28
